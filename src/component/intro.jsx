                    ...
                    info.comments.map((comment, index) => {
                        return (
                            isAmend
                                ...
                                : <div name="comments" className="mb-1 w-full whitespace-pre-line bg-transparent outline-none resize-none text-sm lg:text-base font-medium text-gray-900" data-index={index} key={index} >{comment}</div>
                        )
                    })
                }
            </div>
